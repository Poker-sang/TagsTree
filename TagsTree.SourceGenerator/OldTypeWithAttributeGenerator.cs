...
/// </summary>
//[Generator]
public class OldTypeWithAttributeGenerator : IIncrementalGenerator
{
    /// <summary>
    ...
    private static readonly Dictionary<string, TypeWithAttribute> Attributes = new()
    {
        ...
        { "TagsTree.Attributes.DependencyPropertyAttribute<T>", TypeWithAttributeDelegates.DependencyProperty }
    };
