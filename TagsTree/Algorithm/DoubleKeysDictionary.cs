...
public class DoubleKeysDictionary<TKey1, TKey2, TValue> where TKey1 : notnull where TKey2 : notnull where TValue : notnull
{
    ...
    private readonly Dictionary<TKey1, TKey2> _dict1 = [];
    ...
    public TValue? GetValueOrDefault(TKey2 key2) => _dict2.GetValueOrDefault(key2);
    ...
    {
        if (!_dict1.TryGetValue(key1, out var value))
            return false;
