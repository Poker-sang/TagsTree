...
namespace TagsTree.Views.Controls
{
	...
	public partial class FileProperties : ContentDialog, INotifyPropertyChanged
	{
		...
		private void EditTagsBClick(object sender, RoutedEventArgs e) => new FileEditTags(MainService.Win, FileViewModel).ShowDialog();
		...
		{
			var dialog = new InputName(MainService.Win, App.FileX.InvalidMode.Name, FileViewModel.Name);
