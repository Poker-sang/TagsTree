	...
	public partial class App
	{
		public class CIconOfPath
		{
			...
			[ComImport, Guid("46EB5926-582E-4017-9FDF-E8998DAA0950"),
			 InterfaceType(ComInterfaceType.InterfaceIsIUnknown)] //helpString("Image List"),
			private interface IImageList
			{
				...
				[PreserveSig]
				int Draw(ref ImageListDrawParams imageListDrawParams);
			...
			private static extern int SHGetFileInfo(string pszPath, int dwFileAttributes, ref ShFileInfo psfi,
				int cbFileInfo, uint uFlags);

			[DllImport("Shell32.dll")]
			private static extern int SHGetFileInfo(IntPtr pszPath, uint dwFileAttributes, ref ShFileInfo psfi,
				int cbFileInfo, uint uFlags);
			...
			{
				var ic2 = Imaging.CreateBitmapSourceFromHIcon(ic.Handle, Int32Rect.Empty,
