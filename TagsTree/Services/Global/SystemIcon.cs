...
namespace TagsTree
{
	...
	public partial class App
	{
        public static class SystemIcon
        {
            ...
            private static ImageSource ChangeIconToImageSource(Icon icon) => Imaging.CreateBitmapSourceFromHIcon(icon.Handle, Int32Rect.Empty, BitmapSizeOptions.FromEmptyOptions());
